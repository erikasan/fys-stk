In this folder we have the notebook and two python files that test the code. We also have some of the main code in this folder because the test is dependent on the code being in the same folder.
